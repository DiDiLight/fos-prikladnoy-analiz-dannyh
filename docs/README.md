...
| [measurement-model.md](measurement-model.md) | единая таблица «элемент — индикатор — дескриптор — свидетельство — балл» |
...
| [quality-checklist.md](quality-checklist.md) | чек-лист готовности к публикации |
| [review-guide.md](review-guide.md) | инструкция для внешней команды-рецензента |
| [attachments](attachments/) | редактируемые версии РПД, входного профиля и презентации |
